...
```typescript
import { PostV1LeaderboardGetGroupLeaderboardResponse } from "@steamsets/client-ts/models/operations";

let value: PostV1LeaderboardGetGroupLeaderboardResponse = {
  httpMeta: {
