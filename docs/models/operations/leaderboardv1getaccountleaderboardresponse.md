...
```typescript
import { LeaderboardV1GetAccountLeaderboardResponse } from "@steamsets/client-ts/models/operations";

let value: LeaderboardV1GetAccountLeaderboardResponse = {
  httpMeta: {
