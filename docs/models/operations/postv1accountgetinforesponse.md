...
```typescript
import { PostV1AccountGetInfoResponse } from "@steamsets/client-ts/models/operations";

let value: PostV1AccountGetInfoResponse = {
  httpMeta: {
  ...
  v1AccountGetInfoResponseBody: {
    ...
    name: "steamsets",
    nextAllowedTime: new Date("2024-05-04T05:34:31.586Z"),
