...
```typescript
import { PostV1AccountListFriendsResponse } from "@steamsets/client-ts/models/operations";

let value: PostV1AccountListFriendsResponse = {
  httpMeta: {
    ...
    friends: [
      {
        ...
        foilBadges: 123456,
        friends: 123456,
        friendsSince: new Date("2025-12-24T05:06:53.754Z"),
        gameBans: 666184,
        level: 123456,
        name: "steamsets",
