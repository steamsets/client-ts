...
| `fromLevel`                                                                    | *number*                                                                       | :heavy_check_mark:                                                             | Inclusive bucket lower bound (level)                                           | 10                                                                             |
| `fromXp`                                                                       | *number*                                                                       | :heavy_check_mark:                                                             | XP required for fromLevel                                                      | 5500                                                                           |
| `rank`                                                                         | *number*                                                                       | :heavy_minus_sign:                                                             | N/A                                                                            | 312                                                                            |
| `score`                                                                        | *number*                                                                       | :heavy_minus_sign:                                                             | N/A                                                                            | 6342                                                                           |
| `toLevel`                                                                      | *number*                                                                       | :heavy_check_mark:                                                             | Inclusive bucket upper bound (level)                                           | 19                                                                             |
| `toXp`                                                                         | *number*                                                                       | :heavy_check_mark:                                                             | XP required for toLevel+1, minus 1 — i.e. the cap of this bucket               | 7499                                                                           |