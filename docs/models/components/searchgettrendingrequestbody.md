...
| `source`                                                                                                       | [components.SearchGetTrendingRequestBodySource](../../models/components/searchgettrendingrequestbodysource.md) | :heavy_check_mark:                                                                                             | Which search surface to query.                                                                                 |
