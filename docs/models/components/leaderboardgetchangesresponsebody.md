...
| `total`                                                                                                                                                         | *number*                                                                                                                                                        | :heavy_check_mark:                                                                                                                                              | Total accounts in this slice, ignoring limit/offset — page until limit+offset reaches it. Reflects the topFilter, since each rank bucket is counted separately. |                                                                                                                                                                 |