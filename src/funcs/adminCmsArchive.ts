 ...
 */
export function adminCmsArchive(
  client: SteamSetsCore,
  request: components.V1AdminCmsArchiveRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CmsArchiveResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V1AdminCmsArchiveRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin.cms.archive")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CmsArchiveResponse$inboundSchema),
