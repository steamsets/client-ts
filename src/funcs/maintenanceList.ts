...
export function maintenanceList(
  ...
  Result<
    operations.MaintenanceListResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const path = pathToFunc("/v1/maintenance.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MaintenanceListResponse$inboundSchema, {
      key: "ListResponseBody",
    }),
