 ...
 */
export function adminCmsDelete(
  client: SteamSetsCore,
  request: components.V1AdminCmsDeleteRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CmsDeleteResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V1AdminCmsDeleteRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin.cms.delete")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CmsDeleteResponse$inboundSchema),
