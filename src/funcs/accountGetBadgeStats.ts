...
export function accountGetBadgeStats(
  ...
  Result<
    operations.AccountGetBadgeStatsResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  ...
  const path = pathToFunc("/v1/account.getBadgeStats")();
  ...
  const context = {
    ...
    operationID: "account.getBadgeStats",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountGetBadgeStatsResponse$inboundSchema, {
      key: "V1AccountBadgeStats",
    }),
