 ...
 */
export function activityListGlobalFeed(
  client: SteamSetsCore,
  request: components.V1ActivityListGlobalFeedRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListGlobalFeedResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListGlobalFeedResponse$inboundSchema, {
