...
export enum ActivityStreamGlobalFeedAcceptEnum {
 ...
 */
export function activityActivityStreamGlobalFeed(
  ...
  Result<
    operations.ActivityStreamGlobalFeedResponse,
    | SteamSetsError
...
> {
  ...
  const context = {
    ...
    operationID: "activity.streamGlobalFeed",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.sse(200, operations.ActivityStreamGlobalFeedResponse$inboundSchema, {
    ...
    M.json(
      "default",
      operations.ActivityStreamGlobalFeedResponse$inboundSchema,
      { ctype: "application/problem+json", key: "ErrorModel" },
    ),
