 ...
 */
export function adminCmsPublish(
  client: SteamSetsCore,
  request: components.V1AdminCmsPublishRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CmsPublishResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V1AdminCmsPublishRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin.cms.publish")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CmsPublishResponse$inboundSchema),
