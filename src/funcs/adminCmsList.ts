...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CmsListRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin.cms.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CmsListResponse$inboundSchema, {
      key: "V1AdminCmsListResponseBody",
    }),
