...
export function accountCreateConnection(
  ...
  Result<
    operations.PostV1AccountCreateConnectionResponse,
    | errors.ErrorModel
    | errors.ErrorModel
    | SDKError
    | SDKValidationError
...
> {
  ...
  const context = {
    ...
    operationID: "post-v1-account-create-connection",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.PostV1AccountCreateConnectionResponse$inboundSchema,
