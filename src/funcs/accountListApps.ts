 ...
 */
export function accountListApps(
  ...
  PageIterator<
    Result<
      operations.AccountListAppsResponse,
      | errors.ErrorModel
      | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V1AccountListAppsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/account.listApps")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountListAppsResponse$inboundSchema, {
      key: "V1AccountListAppsResponseBody",
    }),
  ...
  const nextFunc = (
    ...
    const results = (responseData as { apps: unknown | null }).apps;
