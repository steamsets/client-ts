 ...
 */
export async function accountAccountV1ConnectionUpdateConnection(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.V1UpdateConnectionRequestBody$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/account.v1.AccountService/UpdateConnection")();
