 ...
 */
export function badgePricingSearch(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.BadgePricingSearchRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/badgePricing.search")();
  ...
  const context = {
    ...
    operationID: "badgePricing.search",
    oAuth2Scopes: null,
