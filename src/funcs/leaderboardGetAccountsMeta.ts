...
export function leaderboardGetAccountsMeta(
  ...
  Result<
    operations.PostV1LeaderboardGetAccountsMetaResponse,
    | errors.ErrorModel
    | errors.ErrorModel
    | SDKError
    | SDKValidationError
...
> {
  ...
  const context = {
    ...
    operationID: "post-v1-leaderboard-get-accounts-meta",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.PostV1LeaderboardGetAccountsMetaResponse$inboundSchema,
