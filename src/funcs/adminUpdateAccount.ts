...
export function adminUpdateAccount(
  ...
  Result<
    operations.AdminUpdateAccountResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V1AdminUpdateAccountRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin.updateAccount")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AdminUpdateAccountResponse$inboundSchema, {
      key: "V1AdminUpdateAccountResponseBody",
    }),
