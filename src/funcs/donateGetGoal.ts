...
export function donateGetGoal(
  ...
  Result<
    operations.DonateGetGoalResponse,
    | errors.ErrorModel
    | SteamSetsError
...
> {
  const path = pathToFunc("/v1/donate.getGoal")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DonateGetGoalResponse$inboundSchema, {
      hdrs: true,
      key: "V1DonateGoal",
    }),
