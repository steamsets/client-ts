 ...
 */
export async function connectionAccountV1ConnectionVerifyConnection(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.V1VerifyConnectionRequestBody$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/account.v1.AccountService/VerifyConnection")();
