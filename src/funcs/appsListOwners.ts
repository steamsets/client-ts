 ...
 */
export function appsListOwners(
  ...
  PageIterator<
    Result<
      operations.AppListOwnersResponse,
      | errors.ErrorModel
      | SteamSetsError
...
> {
  const parsed = safeParse(
    request,
    (value) => components.AppListOwnersRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/app.listOwners")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppListOwnersResponse$inboundSchema, {
      key: "AppListOwnersResponseBody",
    }),
