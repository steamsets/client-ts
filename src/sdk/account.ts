...
export class Account extends ClientSDK {
  ...
  async compareBadges(
    ...
    options?: RequestOptions,
  ): Promise<PageIterator<operations.CompareBadgesResponse, { page: number }>> {
    return unwrapResultIterator(accountCompareBadges(
      this,
      request,
      options,
    ));
   ...
   */
  async getBadgeHeatmap(
    request: components.AccountSearch,
    options?: RequestOptions,
  ): Promise<operations.AccountGetBadgeHeatmapResponse> {
    return unwrapAsync(accountGetBadgeHeatmap(
      this,
      request,
      options,
    ));
  ...
  async getTrending(
    ...
    return unwrapAsync(accountGetTrending(
      this,
      request,
      options,
    ));
  ...
  async listApps(
    ...
    PageIterator<operations.AccountListAppsResponse, { page: number }>
  > {
    return unwrapResultIterator(accountListApps(
      this,
      request,
      options,
    ));
  ...
  async listBadges(
    ...
    PageIterator<operations.AccountListBadgesResponse, { page: number }>
  > {
  ...
  async listOwnedGroups(
    ...
    return unwrapAsync(accountListOwnedGroups(
      this,
      request,
      options,
    ));
