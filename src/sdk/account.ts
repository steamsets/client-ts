...
import { accountAccountV1SettingsUpdateVanity } from "../funcs/accountAccountV1SettingsUpdateVanity.js";
...
export class Account extends ClientSDK {
  ...
  async accountV1SettingsUpdateVanity(
    request: components.V1UpdateVanityRequestBody,
    options?: RequestOptions,
  ): Promise<operations.AccountV1SettingsUpdateVanityResponse> {
    return unwrapAsync(accountAccountV1SettingsUpdateVanity(
      this,
      request,
      options,
    ));
