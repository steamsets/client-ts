...
export function v1LeaderboardBadgeInfoToJSON(
  v1LeaderboardBadgeInfo: V1LeaderboardBadgeInfo,
): string {
  return JSON.stringify(
    V1LeaderboardBadgeInfo$outboundSchema.parse(v1LeaderboardBadgeInfo),
  );
}
