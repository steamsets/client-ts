 ...
 */
export const BadgeListCraftersEntryNameEffect = {
  None: "none",
  Rainbow: "rainbow",
  Glitch: "glitch",
  Shadow: "shadow",
 ...
 * Donator name effect, none when unset or the account no longer holds an entitling role
 */
export type BadgeListCraftersEntryNameEffect = OpenEnum<
  typeof BadgeListCraftersEntryNameEffect
>;
...
export type BadgeListCraftersEntry = {
   ...
   * Donator name effect, none when unset or the account no longer holds an entitling role
   */
  nameEffect: BadgeListCraftersEntryNameEffect;
  /**
...
/** @internal */
export const BadgeListCraftersEntryNameEffect$inboundSchema: z.ZodType<
  BadgeListCraftersEntryNameEffect,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(BadgeListCraftersEntryNameEffect);
...
> = z.object({
  ...
  name: z.string(),
  nameEffect: BadgeListCraftersEntryNameEffect$inboundSchema,
