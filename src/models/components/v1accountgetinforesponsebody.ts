...
/** @internal */
export type V1AccountGetInfoResponseBody$Outbound = {
...
/** @internal */
export const V1AccountGetInfoResponseBody$outboundSchema: z.ZodType<
  V1AccountGetInfoResponseBody$Outbound,
  z.ZodTypeDef,
  V1AccountGetInfoResponseBody
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace V1AccountGetInfoResponseBody$ {
  /** @deprecated use `V1AccountGetInfoResponseBody$inboundSchema` instead. */
  export const inboundSchema = V1AccountGetInfoResponseBody$inboundSchema;
  /** @deprecated use `V1AccountGetInfoResponseBody$outboundSchema` instead. */
  export const outboundSchema = V1AccountGetInfoResponseBody$outboundSchema;
  /** @deprecated use `V1AccountGetInfoResponseBody$Outbound` instead. */
  export type Outbound = V1AccountGetInfoResponseBody$Outbound;
}

export function v1AccountGetInfoResponseBodyToJSON(
  v1AccountGetInfoResponseBody: V1AccountGetInfoResponseBody,
): string {
  return JSON.stringify(
    V1AccountGetInfoResponseBody$outboundSchema.parse(
      v1AccountGetInfoResponseBody,
    ),
  );
}
