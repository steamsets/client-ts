 ...
 * The privacy of the account
 */
export type AppListOwnersEntryPrivacy = OpenEnum<
  typeof AppListOwnersEntryPrivacy
>;

export type AppListOwnersEntry = {
  /**
  ...
  normalBadges: number;
  /**
   * Minutes this account has played the app
   */
  playtime: number;
  /**
   ...
   * The privacy of the account
   */
  privacy: AppListOwnersEntryPrivacy;
...
export const AppListOwnersEntryPrivacy$inboundSchema: z.ZodType<
  AppListOwnersEntryPrivacy,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AppListOwnersEntryPrivacy);

/** @internal */
export const AppListOwnersEntry$inboundSchema: z.ZodType<
  AppListOwnersEntry,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  privacy: AppListOwnersEntryPrivacy$inboundSchema,
...
export function appListOwnersEntryFromJSON(
  jsonString: string,
): SafeParseResult<AppListOwnersEntry, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AppListOwnersEntry$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AppListOwnersEntry' from JSON`,
  );
}
